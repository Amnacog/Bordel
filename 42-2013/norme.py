...
-score: n'affiche pas le nombre de faute de norme
-libc: desactive la verification des fonctions de la libc
...
class norme:
    ...
    def check_line(self):
        ...
        if self.libc != 0:
            ...
            self.check_regex('[^_](<stdio.h>)', 'Include interdit')
        self.check_nbchar()
        self.check_cfunc()
        self.check_arg()
        self.check_comment()
...
def help():
    ...
    print "-score: n'affiche pas le nombre de faute de norme"
    print "-libc: desactive la verification des fonctions de la libc"
    print "-malloc: active le controle du malloc"
